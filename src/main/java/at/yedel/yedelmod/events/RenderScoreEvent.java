...
public class RenderScoreEvent extends Event {
    ...
    public RenderScoreEvent(RenderPlayer renderer, AbstractClientPlayer entityIn, double x, double y, double z, String str, float p1770699, double p17706910, CallbackInfo ci) {
